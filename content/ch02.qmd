...
```{mermaid}
flowchart TB
    subgraph VP["① Value Proposition (V)"]
        VP1["What problem are we solving?<br/>Which customer need are we satisfying?"]
    end
    
    subgraph VC["② Value Creation (C-side)"]
        KA["Key Activities"]
        KR["Key Resources"]
        KP["Key Partners"]
    end
    
    subgraph VA["③ Value Appropriation (P-side)"]
    ...
    subgraph VSus["④ Value Sustaining (underlying)"]
        COST["Cost Structure"]
    end
    ...
    style VP fill:#004030,stroke:#004030,color:#FFFFFF
    style VC fill:#D8C3A5,stroke:#004030,color:#2C2C2C
    style VA fill:#EFE4D2,stroke:#004030,color:#2C2C2C
    style VSus fill:#FAF6F0,stroke:#004030,color:#2C2C2C
```
